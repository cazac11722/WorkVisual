                ...
                <div className="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
                    <div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                        <ul className="pb-2 space-y-2">
                            <li>
                                <SidebarItem href="/" name="대시보기" icon="Dashboard" />
                            </li>
                            <li>
                                <SidebarItem href="/a/m" name="내프로젝트" icon="Project" />
                            </li>
                            <li>
                                <SidebarItem href={`/m/m/${user.id}`} name="팀활동" icon="Comments" />
                            </li>
                            <li>
                                <SidebarItem href={`/l/m/${user.id}`} name="코멘트 및 기타관리" icon="Commuting" />
                            </li>
                            <li>
                                <SidebarItem href={`/ap/m/${user.id}`} name="활동 로그" icon="ActivityLog" />
                            </li>
                        </ul>
                    </div>
                </div>
